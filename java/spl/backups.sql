...
CREATE TABLE `goods` (
  ...
  `imgUrl` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
...
CREATE TABLE `ums_menu` (
  ...
  `hidden` int DEFAULT '0' COMMENT '菜单隐藏,路由还需要',
  `sort` int DEFAULT NULL COMMENT '排序',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=231 DEFAULT CHARSET=utf8mb3 COMMENT='后台菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ums_role_menu_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8mb3 COMMENT='后台角色菜单关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-06 17:48:44
